...
public class OrderServiceTest {
    ...
    public void calculateTotalPriceForMonthTest() {
        ...
        given(orderRepository.sumTotalAmountByOrderMonth(month.atDay(1), month.atEndOfMonth())).willReturn(Optional.of(BigDecimal.valueOf(600)));
